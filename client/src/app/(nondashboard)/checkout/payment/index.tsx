  ...
  return (
    <div className='payment'>
        ...
        <div className='payment__actions'>
            <Button  onClick={handleSignOutAndNavigate} className='hover:bg-white-50/10 bg-foreground hover:text-white' variant={"outline"} type='button'>Switch Account</Button>
            <Button form='payment-form' variant={"outline"} type='submit' className='payment__submit' disabled={!stripe || !elements}>
